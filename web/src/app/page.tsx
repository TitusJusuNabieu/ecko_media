...
import { 
  Radio, Play, Pause, Volume2, Calendar, Clock, ArrowRight, 
  Mic2, Heart, Users, TrendingUp, Newspaper, MessageCircle,
  Music, Sparkles, Target
} from 'lucide-react';
...
export default function HomePage() {
  ...
  const getTodayPrograms = () => {
    ...
    return programs.filter(p => {
      ...
      let schedule = typeof p.schedule === 'string' ? JSON.parse(p.schedule) : p.schedule;
      const timeSlot = schedule[today];
      return {
        time: timeSlot.start,
        name: p.name,
        host: p.host_name
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center space-y-8">
              ...
              <p className="text-xl md:text-2xl text-white/80 max-w-2xl mx-auto leading-relaxed">
                Broadcasting the Good News and Reaching the Unreached 24/7
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              ...
              <span className="block text-primary">Gospel Broadcasting</span>
            </h2>
            <p className="text-muted-foreground text-lg">
              Experience uplifting content designed to inspire, educate, and bring communities together
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Daily programs designed to uplift and encourage through God\'s Word',
              ...
              },
              {
                ...
                description: 'Serving Bo and surrounding areas with relevant news and events',
              ...
              },
              {
                icon: Music,
                title: 'Gospel Music',
                description: 'The best selection of contemporary and traditional gospel music',
                ...
                <CardHeader className="text-center space-y-4">
                  <div className="flex justify-center">
                    <div className={`p-4 rounded-2xl ${feature.bgColor} group-hover:scale-110 transition-transform duration-300`}>
                      <feature.icon className={`w-12 h-12 bg-gradient-to-br ${feature.color} bg-clip-text text-transparent`} style={{WebkitTextFillColor: 'transparent', WebkitBackgroundClip: 'text', backgroundClip: 'text'}} />
                    </div>
                  </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12">
              <div>
                ...
                <p className="text-muted-foreground text-lg">Check out our inspiring programs for today</p>
              </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="flex justify-between items-center mb-12">
                <div>
                  ...
                  <h2 className="text-4xl md:text-5xl font-bold mb-2">From Our Blog</h2>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-xl md:text-2xl text-white/90 max-w-2xl mx-auto">
              Help us continue spreading the Good News and serving our community through your generous support
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <Button size="lg" className="bg-primary text-secondary hover:bg-primary/90 text-lg px-10 py-7 font-bold">
                <Heart className="w-6 h-6 mr-3" />
                Make a Donation
              </Button>
              <Button size="lg" variant="outline" className="border-2 border-primary text-primary hover:bg-primary hover:text-secondary text-lg px-10 py-7 font-bold">
